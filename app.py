...
# 🧾 Fayllar mavjud bo‘lmasa, yaratish (IP log fayli olib tashlandi)
...
# 🏠 Asosiy yo‘nalish -> home sahifasiga yo‘naltirish
@app.route('/')
def index():
...
def vote():
    ...
    # IP yozish kodi OLIB TASHLANDI (Vercelda read-only muammo bo‘lmasin uchun)
